...
export function LeftSideMenu() {
  return (
    <>
      <div className="bg-blue-50 md:p-4 md:mr-12 md:mt-16 md:fixed  bottom-0 left-0 md:top-0 sticky p-0 flex md:flex-col flex-row justify-start items-center  md:py-4 ">
